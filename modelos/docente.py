...
class Docente(Persona):
    ...
    def modificar_datos_docente(self):
        ...
        print("")
        print("-"*40)
        print(f"Actualmente tiene: {len(self.registro)} docentes") #muestra al cantidad de registros
        print("-"*40)
        print("")
    ...
    def eliminar_docentes(self):
        ...
        #Verifica que se ingrese algun dato
            ...
            del self.registro[eliminador] #Eliminar lista de datos del docente elegido
